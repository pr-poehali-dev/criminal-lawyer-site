...
const services = [
  ...
  },
  {
    ...
    desc: "Если к вам пришли с обыском или решается вопрос о задержании — не паникуйте. Позвоните прямо сейчас. Детально объясню, что делать и как себя вести.",
    urgent: true,
  },
  {
    icon: "MessageSquare",
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-5 lg:px-8 w-full py-20">
          <div className="max-w-2xl">
            ...
            <span className="animate-fade-in-up delay-100 inline-block font-ibm text-xs font-medium tracking-[0.22em] uppercase text-[hsl(43,65%,52%)] mb-6">
              Адвокат по уголовным делам · Иркутск и Улан-Удэ
            </span>
            ...
            <div>
              ...
              <div className="border-l-2 border-[hsl(43,65%,52%)/40] pl-5 mb-8">
                <p className="font-cormorant text-xl italic text-[hsl(45,20%,78%)] leading-relaxed">
                  Не оставайтесь один на один с системой. Звоните прямо сейчас — разберем вашу ситуацию и начнем действовать.
                </p>
              </div>
